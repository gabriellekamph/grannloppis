...
const LogoutBtn = () => {
    ...
    return (
        ...
        <div className="container max-w-sm h-auto bg-white mx-auto text-black p-5 m-5 flex overflow-x-hidden inset-x-0 overflow-y-auto z-50 fixed outline-none focus:outline-none rounded-md px-5">
            <form>
              <h1 className="font-bold text-md mb-3 text-center">Är du säker på att du vill logga ut?</h1>
              <p className="text-sm text-center">Om du vill logga in på nytt senare behöver du en ny inloggningslänk.</p>
